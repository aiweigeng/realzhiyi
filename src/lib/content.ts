...
export const articles: Article[] = [
  ...
  {
    slug: "personal-website-as-long-term-container",
    title: "个人网站不是一次性页面",
    date: "2026-07-04",
    summary: "个人网站更像一个长期容器，用来保存公开表达、项目记录和仍在形成中的判断。",
    body: [
      "个人网站不需要一开始就完整。它更重要的作用，是给长期内容一个稳定的位置。",
      "当文章、项目和想法不断散落在不同工具里，人会很难重新看见自己的积累。网站的价值不是装饰，而是让适合公开的内容被保存、连接和再次使用。"
    ]
  },
  {
    slug: "ai-collaboration-needs-judgment",
    title: "AI 协作中最重要的不是速度",
    date: "2026-07-04",
    summary: "速度会放大产出，也会放大混乱。AI 协作真正需要保留的是人的判断和边界。",
    body: [
      "AI 可以让很多事情变快，但快本身不是目标。",
      "如果没有判断，速度只会把模糊想法更快地变成更多内容。真正好的协作，是让问题更清楚，让重复劳动变少，让人能把注意力放回重要选择。"
    ]
  }
];
